...
public class Debug{
    public static void main(String[] args){
        HW11_8110056004_1 solve1 = new HW11_8110056004_1();
        HW11_8110056004_1 solve2 = new HW11_8110056004_1();
        int[][] t1 = {{1,4,3,1,3,2},{3,2,1,3,2,4},{2,3,3,2,3,1}};
        int[][] t2 = {{3,3,3,3,3},{3,2,2,2,3},{3,2,1,2,3},{3,2,2,2,3},{3,3,3,3,3}};

        System.out.println( solve1.count_water_volume(t1) );
        System.out.println( solve2.count_water_volume(t2) );
    }
